...
select_cont66:                                    ; preds = %select_false65, %select_true64
  ...
  %138 = getelementptr [4 x i8], ptr @printf_integer_format, i32 0, i32 0
  %139 = call i32 (ptr, ...) @printf(ptr %138, i32 10)
  %140 = select i1 true, ptr @printf_true_format, ptr @printf_false_format
  %141 = call i32 (ptr, ...) @printf(ptr %140)
  %142 = select i1 true, ptr @printf_true_format, ptr @printf_false_format
  %143 = call i32 (ptr, ...) @printf(ptr %142)
  %144 = select i1 true, ptr @printf_true_format, ptr @printf_false_format
  %145 = call i32 (ptr, ...) @printf(ptr %144)
  %146 = getelementptr [4 x i8], ptr @printf_integer_format, i32 0, i32 0
  %147 = call i32 (ptr, ...) @printf(ptr %146, i32 777)
  %148 = add i32 %134, %133
  %149 = getelementptr [4 x i8], ptr @printf_integer_format, i32 0, i32 0
  %150 = call i32 (ptr, ...) @printf(ptr %149, i32 %148)
  %151 = sub i32 %132, %134
  %152 = getelementptr [4 x i8], ptr @printf_integer_format, i32 0, i32 0
  %153 = call i32 (ptr, ...) @printf(ptr %152, i32 %151)
  %154 = add i32 %134, %133
  %155 = mul i32 %154, 2
  %156 = getelementptr [4 x i8], ptr @printf_integer_format, i32 0, i32 0
  %157 = call i32 (ptr, ...) @printf(ptr %156, i32 %155)
  br label %exit

exit:                                             ; preds = %select_cont66
  ret i32 0
}
