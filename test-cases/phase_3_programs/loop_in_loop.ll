; ModuleID = 'Module'
source_filename = "loop_in_loop.sl"
...
loop_condition2:                                  ; preds = %loop_continuation11, %entry
  %0 = phi i32 [ %5, %loop_continuation11 ], [ 1, %entry ]
  %1 = phi i32 [ %11, %loop_continuation11 ], [ 1, %entry ]
  %2 = icmp slt i32 %1, 5
...
loop_condition9:                                  ; preds = %loop_body10, %loop_body3
  %5 = phi i32 [ %9, %loop_body10 ], [ %0, %loop_body3 ]
  %6 = phi i32 [ %6, %loop_body10 ], [ %1, %loop_body3 ]
  %7 = phi i32 [ %10, %loop_body10 ], [ 0, %loop_body3 ]
  %8 = icmp slt i32 %7, %6
  br i1 %8, label %loop_body10, label %loop_continuation11

loop_body10:                                      ; preds = %loop_condition9
  %9 = add i32 %5, <null operand!>
  %10 = add i32 %7, 1
  br label %loop_condition9
